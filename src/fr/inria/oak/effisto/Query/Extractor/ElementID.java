...
public interface ElementID {
	 ...
	 */
	public boolean isParentOf(ElementID id2);
	
	/**
	 * @param id2
	 * @return true if id1 is an ancestor of id2
	 */
	public boolean isAncestorOf(ElementID id2);
	
	/**
	 * @return the parent ID if it can be computed
	 */
	public ElementID getParent();
	
	/**
	 * @param id2
	 * @return true if this element ID starts strictly after id2
	 */
	public boolean startsAfter(ElementID id2);
	 ...
	 */
	public boolean endsAfter(ElementID id2);
